...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ag_grid_community_client_side_row_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent() {
        ...
        this.modules = [_ag_grid_community_client_side_row_model__WEBPACK_IMPORTED_MODULE_2__["ClientSideRowModelModule"]];
      ...
      _createClass(AppComponent, [{
        key: "createLeftRowData",
        value: function createLeftRowData() {
          var _this = this;

          var data = [];
          ['Red', 'Green', 'Blue'].forEach(function (color) {
            data.push(_this.createDataItem(color));
          });
          return data;
        }
      }, {
        key: "createDataItem",
        value: function createDataItem(color) {
          return {
        ...
        key: "binDragOver",
        value: function binDragOver(event) {
        ...
        key: "binDrop",
        value: function binDrop(event) {
          event.preventDefault();
          var jsonData = event.dataTransfer.getData("application/json");
          var data = JSON.parse(jsonData); // if data missing or data has no id, do nothing
        ...
        key: "dragStart",
        value: function dragStart(event, color) {
        ...
        key: "gridDragOver",
        value: function gridDragOver(event) {
        ...
        key: "gridDrop",
        value: function gridDrop(event, grid) {
          event.preventDefault();
          var userAgent = window.navigator.userAgent;
          var isIE = userAgent.indexOf('Trident/') >= 0;
          var jsonData = event.dataTransfer.getData(isIE ? 'text' : 'application/json');
          var data = JSON.parse(jsonData); // if data missing or data has no it, do nothing

          if (!data || data.id == null) {
            return;
          }

          var gridApi = grid == 'left' ? this.leftGridOptions.api : this.rightGridOptions.api; // do nothing if row is already in the grid, otherwise we would have duplicates
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./app.component */
    "./src/app/app.component.ts"); // import {ModuleRegistry} from '@ag-grid-community/core';     // @ag-grid-community/core will always be implicitly available
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], ag_grid_angular__WEBPACK_IMPORTED_MODULE_3__["AgGridModule"].withComponents([])],
      providers: [],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Dev\Sandbox\angular8dnd\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
